...
const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hi, I'm Oliver.</span>{" "}
        I'm a{" "}
        <span className="font-bold">full-stack developer</span>{" "}
        proficient in{" "}
        <span className="font-bold">JavaScript, C#</span>{" "}
        and more, with experience developing in professional agile environments.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/oliver-strange-78121a243/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
